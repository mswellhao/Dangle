...
@register_model("transformer_dangle_enc3")
...
@register_model_architecture("transformer_dangle_enc3", "transformer_dangle_enc3")
...
@register_model_architecture("transformer_dangle_enc3", "transformer_dangle_enc3_base")
...
@register_model_architecture("transformer_dangle_enc3", "transformer_dangle_enc3_glove")
def transformer_parsing(args):
...
@register_model_architecture("transformer_dangle_enc3", "transformer_dangle_enc3_glove_rel_pos")
def transformer_parsing(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 300)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 512)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 6)
