...
class LanguageModelingTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--dangle-data', action='store_true',
                            help='use dangle data')
        # fmt: on
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if self.args.dangle_data and split == "train":
            self.datasets[split] = self._initialize_dataset_dangle(
                dataset=dataset,
                sizes=dataset.sizes,
    ...
    def _initialize_dataset_dangle(self, **kwargs):
        return DangleMonolingualDataset(**kwargs)
